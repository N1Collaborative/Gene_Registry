...
const MarketedDrugs = () => {
  ...
  const loadData = async () => {
    try {
      ...
      const response = await fetch('/marketed-drugs.json');
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        ...
        >
          ...
          <p className="text-white text-lg">Loading Marketed Drugs...</p>
        </motion.div>
      </div>
    );
  }
        ...
        >
          <div className="flex bg-white rounded-lg shadow-lg overflow-hidden">
            <input
              ...
              placeholder="Search marketed drugs..."
